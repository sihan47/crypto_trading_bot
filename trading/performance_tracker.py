...
def _load_config() -> dict[str, Any]:
    try:
        ...
        perf_logger.warning(f"Failed to parse {CONFIG_PATH}: {exc}")
        return {}
...
if not api_key or not secret_key:
    raise RuntimeError("BINANCE_API_KEY and BINANCE_SECRET_KEY must be set before tracking performance")
